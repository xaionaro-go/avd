...
replace github.com/xaionaro-go/avpipeline v0.0.0-20250512001453-f7a7eb870ba3 => ../avpipeline
...
require (
	...
	github.com/xaionaro-go/avpipeline v0.0.0-20250512001453-f7a7eb870ba3
